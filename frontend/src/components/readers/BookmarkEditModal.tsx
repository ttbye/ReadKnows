...
export default function BookmarkEditModal({
  ...
  return (
    <>
      ...
      />
      <div
        className="fixed left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-md shadow-2xl z-[91] flex flex-col rounded-lg border"
        style={{
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            paddingBottom: typeof window !== 'undefined' && window.innerWidth < 1024
              ? `calc(0.75rem + ${typeof window !== 'undefined' && window.innerWidth >= 768 ? '64px' : '56px'} + clamp(10px, env(safe-area-inset-bottom, 10px), 34px))`
              : '0.75rem'
          }}
        >
          <button

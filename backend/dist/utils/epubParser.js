...
exports.extractEpubMetadata = extractEpubMetadata;
const fs_1 = __importDefault(require("fs"));
const path_1 = __importDefault(require("path"));
const adm_zip_1 = __importDefault(require("adm-zip"));
const xml2js_1 = require("xml2js");
// 简单的EPUB元数据提取（包含封面图片）
function extractEpubMetadata(filePath, bookDir) {
        ...
        try {
            ...
            (0, xml2js_1.parseString)(containerXml, (err, result) => {
                ...
                try {
                    ...
                    (0, xml2js_1.parseString)(opfXml, async (err2, opfResult) => {
                        if (err2)
                            return reject(err2);
                        try {
                                                    ...
                                                    if (bookDir) {
                                                        try {
                                                            ...
                                                            console.log('[EPUB封面提取] 开始处理封面:', {
                                                                bookDir,
                                                                coverPath,
                                                                bookDirExists: fs_1.default.existsSync(bookDir)
                                                            });
                                                            ...
                                                            // 检查目录权限
                                                            try {
                                                                fs_1.default.accessSync(bookDir, fs_1.default.constants.W_OK);
                                                            ...
                                                            const coverExt = path_1.default.extname(coverPath) || '.jpg';
                                                            ...
                                                            if (!coverBuffer) {
                                                                ...
                                                                if (fs_1.default.existsSync(coverFilePath)) {
                                                                    const stats = fs_1.default.statSync(coverFilePath);
                    ...
                    resolve({
                        title: path_1.default.basename(filePath, '.epub'),
                        author: '未知作者',
                        description: '',
                        language: 'zh',
                        cover_url: null,

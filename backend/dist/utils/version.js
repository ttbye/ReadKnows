...
const getVersionFilePath = () => {
    ...
    if (currentDir.includes('dist')) {
        return (0, path_1.resolve)(currentDir, '../../version.json');
    }
...
const getPackageJsonPath = () => {
    const currentDir = __dirname;
    if (currentDir.includes('dist')) {
        return (0, path_1.resolve)(currentDir, '../../package.json');
    }
    return (0, path_1.resolve)(currentDir, '../../package.json');
};
/**
...
function getVersion() {
    try {
        if ((0, fs_1.existsSync)(VERSION_FILE)) {
            const versionData = JSON.parse((0, fs_1.readFileSync)(VERSION_FILE, 'utf-8'));
...
function saveVersion(version) {
    try {
        ...
        (0, fs_1.writeFileSync)(VERSION_FILE, JSON.stringify(versionData, null, 2), 'utf-8');

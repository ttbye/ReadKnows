...
exports.searchBookByName = searchBookByName;
...
// 从数据库获取豆瓣API地址
function getDoubanApiBase() {
    try {
        const setting = db_1.db.prepare('SELECT value FROM system_settings WHERE key = ?').get('douban_api_base');
...
async function searchBookByName(bookName) {
    try {
        ...
        const response = await axios_1.default.get(url, {
            ...
            httpsAgent: apiBase.startsWith('https://') ? new https_1.default.Agent({
